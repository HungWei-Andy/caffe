...
class VOCSegDataLayer(caffe.Layer):
    ...
    def reshape(self, bottom, top):
        ...
        print 'image dir: {}, list filename: {}'.format(self.voc_dir, self.split)
        print 'train in self.split: {}'.format('train' in self.split) 
        if 'train' not in self.split and not self.start and self.idx == 0:
            raise Exception
    ...
    def forward(self, bottom, top):
        ...
        if self.random:
            ...
            if self.idx == len(self.indices):
                self.idx = 0
                print 'A Round of Images have been completed !'
